...
All error responses include an `Error-Info` header and a JSON body with `@type`:
...
**Response headers:**
- `Error-Info`: Contains machine-readable error code
...
|------|-----------------|
| Products | `identifiers`, `name`, `status` |
